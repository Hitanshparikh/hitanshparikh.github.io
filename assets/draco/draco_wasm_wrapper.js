...
var DracoDecoderModule = function() {
    ...
    return "undefined" != typeof __filename && (t = t || __filename),
        function(e) {
            ...
            var k, x, Q = "./this.program",
                $ = !1,
                W = !1;
            $ = "object" == typeof window, W = "function" == typeof importScripts, k = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node && !$ && !W, x = !$ && !k && !W;
            var H, q, Y = "";
            if (k) {
                Y = __dirname + "/";
                var K = function(t, e) {
                ...
                1 < process.argv.length && (Q = process.argv[1].replace(/\\/g, "/")), process.argv.slice(2), process.on("uncaughtException", (function(t) {
                    throw t
            ...
            }, "undefined" != typeof print && ("undefined" == typeof console && (console = {}), console.log = print, console.warn = console.error = "undefined" != typeof printErr ? printErr : print)) : ($ || W) && (W ? Y = self.location.href : document.currentScript && (Y = document.currentScript.src), t && (Y = t), Y = 0 !== Y.indexOf("blob:") ? Y.substr(0, Y.lastIndexOf("/") + 1) : "", K = function(t) {
            ...
            B = null, w.thisProgram && (Q = w.thisProgram), w.wasmBinary && (X = w.wasmBinary), "object" != typeof WebAssembly && tt("no native wasm support detected");
            ...
            var Tt = {},
                ...
                vt = function() {
                    ...
                    function r(t) {
                        return (X || !$ && !W || "function" != typeof fetch ? new Promise((function(t, e) {
                            t(c())
                        })) : fetch(ht, {
            ...
            var an = {
                ...
                alloc: function(t, e) {
                    return r(an.buffer), t = (t = t.length * e.BYTES_PER_ELEMENT) + 7 & -8, an.pos + t >= an.size ? (r(0 < t), an.needed += t, e = w._malloc(t), an.temps.push(e)) : (e = an.buffer + an.pos, an.pos += t), e
                },
                copy: function(t, e, r) {
